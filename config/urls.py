...
from pages.views import home, about, add_student, add_invoice, add_lesson, edit_invoice, delete_invoice, student_detail, delete_lesson, student_dashboard, chat_view
